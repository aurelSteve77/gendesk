...
Generated by `gendesk eval report` into
[`artifacts/reports/RESULTS.md`](artifacts/reports/RESULTS.md). See
[`docs/limitations.md`](docs/limitations.md) before reading any of it -- the honest
constraints on what these numbers mean are listed there first.
